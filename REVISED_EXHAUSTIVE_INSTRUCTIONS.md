Areferring to claude shkill# REVISED EXHAUSTIVE INSTRUCTIONS FOR AI ORCHESTRATOR
...
1. **Project Structure**
   ...
   - [ ] Set up libraries (tools, skills, prompting, context, mcp)
   - [ ] Initialize TODO system (all 4 levels)

   - [ ] Create library management directories
...
3. **RESEARCH TEAM**
   ...
   - [ ] Research workflows (PLAN→RESEARCH→HYPOTHESIZE→TEST→THEORIZE→ITERATE)
   - [ ] Continuous monitoring system

4. **LIBRARY MANAGEMENT AGENTS**
   - [ ] **SKILLS AGENT**
...
5. **ENVIRONMENT TECH**
   - [ ] Error detection
   - [ ] Auto-fix capabilities (CAN actually fix, not just report)
   - [ ] Environment management
   - [ ] System monitoring
   - [ ] Dependency management

6. **SPECIALIZED CODING AGENTS**
   - [ ] Architect agent
   - [ ] Backend agent
   - [ ] Frontend agent
   - [ ] Testing agent
   - [ ] DevOps agent
   - [ ] Documentation agent
   - [ ] All agents can collaborate with library agents
---
...
**Build Knowledge Base & Enable Dynamic Creation**

1. **Tools Library (Managed by Tools Agent)**
...
2. **Skills Library (Managed by Skills Agent)**
   - [ ] Coding skills
   - [ ] Architecture skills
   - [ ] Testing skills
   - [ ] DevOps skills
   - [ ] Meta-skills (learning, collaboration)
   - [ ] Skill creation framework
   - [ ] Skill mastery tracking
   - [ ] Skill evolution system

3. **MCP Library (Managed by MCP Server Agent)**
   - [ ] Code context MCP servers
   - [ ] Project context MCP servers
   - [ ] Knowledge base MCP servers
   - [ ] Tool registry MCP servers
   - [ ] Custom MCP creation framework
   - [ ] MCP protocol optimization
   - [ ] MCP effectiveness metrics
...
6. **Memory System**
   - [ ] Multi-tier storage (Working/Short/Long/Archival)
   - [ ] Retrieval system (Semantic/Temporal/Graph/Hybrid)
   - [ ] Consolidation (Nightly/Weekly/Monthly)
   - [ ] Context continuity system
   - [ ] Memory optimization

7. **Dynamic Creation System**
   - [ ] Need identification
   ...
   - [ ] **MANDATE: Every addition MUST improve system**
...
1. **Task Orchestration**
   - [ ] Task decomposition with library needs identification
   - [ ] Dependency resolution
   - [ ] Agent assignment (including library agents)
   - [ ] Progress tracking across all agents
   - [ ] Dynamic tool/skill/MCP creation workflow

2. **Quality Control**
   - [ ] Validation pipelines (99.999999999% standard)
   - [ ] Testing automation
   - [ ] Approval workflows
   - [ ] Feedback loops
   - [ ] Library validation
...
3. **Communication**
   - [ ] Agent-to-agent messaging (Blackbox Cloud)
   - [ ] Shared context updates
   - [ ] Status broadcasting
   - [ ] User notifications
   - [ ] Library agent coordination
...
1. **Learning System**
   - [ ] Metrics collection (all agents + libraries)
   - [ ] Performance analysis
   - [ ] Strategy optimization
   - [ ] Knowledge accumulation
...
3. **Continuous Evolution**
   ...
   - [ ] Feedback integration
   - [ ] Innovation capture
   - [ ] **MANDATE: System MUST improve with each addition**

4. **Improvement Validation**
   - [ ] Capability increase measurement (+5% minimum)
   - [ ] Efficiency increase measurement (+10% minimum)
   - [ ] Quality increase measurement (+5% minimum)
   - [ ] Usage tracking
...
### Step 2: Initialize Library Structures (Day 1)
```bash
# Tools Library
...
### Step 3: Create TODO System (Day 1)
```bash
# Create all TODO levels
touch PROJECT_TODO.md
mkdir -p tasks
touch tasks/{ARCHITECTURE_TODO.md,BACKEND_TODO.md,FRONTEND_TODO.md,TESTING_TODO.md,DEVOPS_TODO.md}
mkdir -p agents/todos
mkdir -p agents/subagents/todos
```

### Step 4: Set Up Core Infrastructure (Day 2-3)
- [ ] Create base agent classes
- [ ] Set up Blackbox Cloud integration
- [ ] Initialize memory system
- [ ] Set up logging infrastructure
- [ ] Create communication protocols

### Step 5: Implement Library Agents (Day 4-5)
- [ ] Skills Agent implementation
- [ ] Tools Agent implementation
- [ ] MCP Server Agent implementation
- [ ] Library management interfaces
- [ ] Dynamic creation workflows

### Step 6: Implement Core Agents (Day 6-10)
- [ ] Prometheus (Orchestrator)
- [ ] Doubtful Thomas (QC)
- [ ] Research Team (AI Scientist + sub-agents)
- [ ] Environment Tech
- [ ] Specialized Coding Agents

### Step 7: Integrate Real Tools (Day 11-14)
- [ ] Claude Code integration (desktop/web via user login)
- [ ] Codex integration (via OpenAI login)
- [ ] GitHub Copilot integration (VS Code extension)
- [ ] Jules CLI integration
- [ ] GitHub Cloud & Actions
- [ ] VS Code control layer

### Step 8: Build VS Code Extension (Day 15-20)
- [ ] Orchestration panel
- [ ] Task visualization
- [ ] Communication hub
- [ ] Library management interface
...
### Step 9: Testing & Validation (Day 21-25)
...
### Step 10: Documentation & Polish (Day 26-30)
